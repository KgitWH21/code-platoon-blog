...
The generated solution glowing beside the blank file, first identify its shape; shape each line into a question, question each answer as you rewrite it, and rebuild the program from what remains. Then close it. A hood of a car.

Today the assignment was a car shop manager — a `Car` class, a terminal menu, the whole loop of add, view, service, update mileage, quit. Simple on paper. Not simple in practice, because this is the second day I've ever touched object-oriented programming.
